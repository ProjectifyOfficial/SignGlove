...
NOTHING = Symbol([Range(937,938), Range(949,951), Range(952,953), Range(957,958), Range(953,956), foo],'NOTHING')
A = Symbol([Range(925,932), Range(917,924), Range(914,926), Range(918,928), Range(925,936), foo], 'A')
L = Symbol([Range(941,947), Range(954,958), Range(924,927), Range(922,933), Range(939,944), foo], 'L')	
U = Symbol([Range(911,915), Range(956,958), Range(953,955), Range(929,933), Range(937,941), foo], 'U')	        
A_star = populate([936, 921, 918, 919, 945, 881], [943, 934, 928, 928, 955, 899], 'A*')
